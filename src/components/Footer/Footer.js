    ...
    <footer className="footer py-5 bg-dark">
      <div className="container">
        <div className="footer-content text-white grid">
          ...
          {/* <div className="footer-item text-center">
            <h6 className='fs-17 fw-6'>About Event Game Booking</h6>
            <ul>
          ...
          <div className="footer-item text-center">
            <h6 className='fs-17 fw-6'>Contact Event Game Booking</h6>
            <ul>
              <li>
                <span><i className="fas fa-phone"></i></span>
                <span className="fs-15">+919638527410</span>
              </li>
              <li>
                <span><i className="fas fa-envelope"></i></span>
                <span className="fs-15">info@egb.com</span>
              </li>
              <li>
                <span><i className="fas"></i></span>
                <span className="fs-15">Made with <span className='text-red fw-6'>&#x2665;</span> in India</span>
              </li>
            </ul>
          </div>
        </div>
