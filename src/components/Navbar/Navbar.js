        ...
        <div className="container">
          <div className="navbar-top flex flex-between">
            <Link to="/" className="navbar-brand">
              <span className="text-regal-blue">Event{" "}</span><span className='text-gold'>Game{" "}</span><span className="text-regal-blue">Booking</span>
              <i className="two-dice text-regal-blue fas fa-dice"></i>
            </Link>
            ...
            <div className="navbar-btns flex">
              <Link to="/login" className="add-to-cart-btn flex">
                <span className="btn-ico user-profile">
